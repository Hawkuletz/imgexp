...
SET COMPOPT="-DUNICODE -D_UNICODE"
mkdir output 2>NUL:
rem call "c:\Program Files\PellesC\Bin\povars32.bat"
del "%PROGNAME%.exe"
echo compiling %PROGNAME%
pocc.exe -std:C11 -I..\mylibs -Tx86-coff -Ot -Ob1 -fp:precise -W1 -Gz -Ze -Go -DUNICODE -D_UNICODE -DDEBUG limg2.c -Fo"output\limg2.obj"
...
echo linking
polink.exe -subsystem:windows -machine:x86 "%PLIBS%" -out:"%PROGNAME%.exe" "output\%PROGNAME%.obj" "output\%PROGNAME%.res"
dir "%PROGNAME%.exe"
